 ...
 */
public class PlayerBaseDrawable implements Drawable {
     ...
     */
    public PlayerBaseDrawable(int x, int y, Color color) {
        this.color = color;
        this.positionX = x;
        this.positionY = y;
    ...
    public PlayerBaseDrawable(PlayerConfiguration configuration, Color color) {
    }
